...
class TarifReferenceOptionTest {
    ...
    void tarifTest() throws Exception {
        ...
        tarifReferenceOption.setTarif(tarifBack);
        assertThat(tarifReferenceOption.getTarif()).isEqualTo(tarifBack);
        assertThat(tarifBack.getTarifReferenceOption()).isEqualTo(tarifReferenceOption);

        tarifReferenceOption.tarif(null);
        assertThat(tarifReferenceOption.getTarif()).isNull();
        assertThat(tarifBack.getTarifReferenceOption()).isNull();
    }
}
