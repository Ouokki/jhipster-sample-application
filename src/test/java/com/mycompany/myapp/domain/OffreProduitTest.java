...
class OffreProduitTest {
    ...
    void crTest() throws Exception {
        ...
        offreProduit.addCr(cRBack);
        assertThat(offreProduit.getCrs()).containsOnly(cRBack);
        assertThat(cRBack.getOffreProduit()).isEqualTo(offreProduit);

        offreProduit.removeCr(cRBack);
        assertThat(offreProduit.getCrs()).doesNotContain(cRBack);
        assertThat(cRBack.getOffreProduit()).isNull();

        offreProduit.crs(new HashSet<>(Set.of(cRBack)));
        assertThat(offreProduit.getCrs()).containsOnly(cRBack);
        assertThat(cRBack.getOffreProduit()).isEqualTo(offreProduit);

        offreProduit.setCrs(new HashSet<>());
        assertThat(offreProduit.getCrs()).doesNotContain(cRBack);
        assertThat(cRBack.getOffreProduit()).isNull();
    }
