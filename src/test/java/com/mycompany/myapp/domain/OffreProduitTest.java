...
class OffreProduitTest {
    ...
    void offreTest() throws Exception {
        ...
        offreProduit.setOffre(offreBack);
        assertThat(offreProduit.getOffre()).isEqualTo(offreBack);

        offreProduit.offre(null);
        assertThat(offreProduit.getOffre()).isNull();
    }
    ...
    void produitTest() throws Exception {
        ...
        offreProduit.setProduit(produitBack);
        assertThat(offreProduit.getProduit()).isEqualTo(produitBack);

        offreProduit.produit(null);
        assertThat(offreProduit.getProduit()).isNull();
    }
}
