...
class ParametrageTest {
    ...
    void demandeTest() throws Exception {
        ...
        parametrage.addDemande(demandeBack);
        assertThat(parametrage.getDemandes()).containsOnly(demandeBack);
        assertThat(demandeBack.getParametrage()).isEqualTo(parametrage);

        parametrage.removeDemande(demandeBack);
        assertThat(parametrage.getDemandes()).doesNotContain(demandeBack);
        assertThat(demandeBack.getParametrage()).isNull();

        parametrage.demandes(new HashSet<>(Set.of(demandeBack)));
        assertThat(parametrage.getDemandes()).containsOnly(demandeBack);
        assertThat(demandeBack.getParametrage()).isEqualTo(parametrage);

        parametrage.setDemandes(new HashSet<>());
        assertThat(parametrage.getDemandes()).doesNotContain(demandeBack);
        assertThat(demandeBack.getParametrage()).isNull();
    }
    ...
    void conformiteTest() throws Exception {
        ...
        parametrage.addConformite(conformiteBack);
        assertThat(parametrage.getConformites()).containsOnly(conformiteBack);
        assertThat(conformiteBack.getParametrage()).isEqualTo(parametrage);

        parametrage.removeConformite(conformiteBack);
        assertThat(parametrage.getConformites()).doesNotContain(conformiteBack);
        assertThat(conformiteBack.getParametrage()).isNull();

        parametrage.conformites(new HashSet<>(Set.of(conformiteBack)));
        assertThat(parametrage.getConformites()).containsOnly(conformiteBack);
        assertThat(conformiteBack.getParametrage()).isEqualTo(parametrage);

        parametrage.setConformites(new HashSet<>());
        assertThat(parametrage.getConformites()).doesNotContain(conformiteBack);
        assertThat(conformiteBack.getParametrage()).isNull();
    }
