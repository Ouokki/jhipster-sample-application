...
class TarifCommercantResourceIT {
    ...
    private static final String DEFAULT_CHAMP_MATRICE = "AAAAAAAAAA";
    private static final String UPDATED_CHAMP_MATRICE = "BBBBBBBBBB";
    ...
    public static TarifCommercant createEntity(EntityManager em) {
        TarifCommercant tarifCommercant = new TarifCommercant()
            .nomCommission(DEFAULT_NOM_COMMISSION)
            .typeCommission(DEFAULT_TYPE_COMMISSION)
            .champMatrice(DEFAULT_CHAMP_MATRICE);
    ...
    public static TarifCommercant createUpdatedEntity(EntityManager em) {
        TarifCommercant tarifCommercant = new TarifCommercant()
            .nomCommission(UPDATED_NOM_COMMISSION)
            .typeCommission(UPDATED_TYPE_COMMISSION)
            .champMatrice(UPDATED_CHAMP_MATRICE);
        return tarifCommercant;
    }
    ...
    void createTarifCommercant() throws Exception {
        ...
        assertThat(testTarifCommercant.getNomCommission()).isEqualTo(DEFAULT_NOM_COMMISSION);
        assertThat(testTarifCommercant.getTypeCommission()).isEqualTo(DEFAULT_TYPE_COMMISSION);
        assertThat(testTarifCommercant.getChampMatrice()).isEqualTo(DEFAULT_CHAMP_MATRICE);
    }
    ...
    void getAllTarifCommercants() throws Exception {
        ...
        restTarifCommercantMockMvc
            ...
            .andExpect(jsonPath("$.[*].champMatrice").value(hasItem(DEFAULT_CHAMP_MATRICE)));
    }
    ...
    void getTarifCommercant() throws Exception {
        ...
        restTarifCommercantMockMvc
            ...
            .andExpect(jsonPath("$.champMatrice").value(DEFAULT_CHAMP_MATRICE));
    }
    ...
    void putExistingTarifCommercant() throws Exception {
        ...
        TarifCommercant testTarifCommercant = tarifCommercantList.get(tarifCommercantList.size() - 1);
        assertThat(testTarifCommercant.getNomCommission()).isEqualTo(UPDATED_NOM_COMMISSION);
        assertThat(testTarifCommercant.getTypeCommission()).isEqualTo(UPDATED_TYPE_COMMISSION);
        assertThat(testTarifCommercant.getChampMatrice()).isEqualTo(UPDATED_CHAMP_MATRICE);
    }
    ...
    void partialUpdateTarifCommercantWithPatch() throws Exception {
        ...
        partialUpdatedTarifCommercant.nomCommission(UPDATED_NOM_COMMISSION).typeCommission(UPDATED_TYPE_COMMISSION);
