...
import offreResolve from './offre-routing-resolve.service';

describe('Offre routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: OffreService;
  let resultOffre: IOffre | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IOffre returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        offreResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultOffre = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOffre).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOffre>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
