...
type OffreProduitFormDefaults = Pick<
  NewOffreProduit,
  'id' | 'activeProd' | 'activeNEHOM' | 'activeVMOA' | 'activeDEVTU' | 'offres' | 'produits'
>;
...
type OffreProduitFormGroupContent = {
  ...
  offres: FormControl<IOffreProduit['offres']>;
  produits: FormControl<IOffreProduit['produits']>;
};
...
export class OffreProduitFormService {
  createOffreProduitFormGroup(offreProduit: OffreProduitFormGroupInput = { id: null }): OffreProduitFormGroup {
    ...
    return new FormGroup<OffreProduitFormGroupContent>({
      ...
      offres: new FormControl(offreProduitRawValue.offres ?? []),
      produits: new FormControl(offreProduitRawValue.produits ?? []),
    });
  }
