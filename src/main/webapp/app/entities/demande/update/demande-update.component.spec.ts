...
describe('Demande Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Parametrage query and add missing value', () => {
      ...
      const parametrage: IParametrage = { id: 25826 };
      demande.parametrage = parametrage;

      const parametrageCollection: IParametrage[] = [{ id: 30772 }];
    ...
    it('Should update editForm', () => {
      const demande: IDemande = { id: 456 };
      const parametrage: IParametrage = { id: 18336 };
      demande.parametrage = parametrage;
