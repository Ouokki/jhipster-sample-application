...
describe('OptionProduitCommerces Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call tarif query and add missing value', () => {
      const optionProduitCommerces: IOptionProduitCommerces = { id: 456 };
      const tarif: ITarif = { id: 2825 };
      optionProduitCommerces.tarif = tarif;

      const tarifCollection: ITarif[] = [{ id: 14900 }];
    ...
    it('Should call Parametrage query and add missing value', () => {
      const optionProduitCommerces: IOptionProduitCommerces = { id: 456 };
      const parametrage: IParametrage = { id: 21419 };
      optionProduitCommerces.parametrage = parametrage;

      const parametrageCollection: IParametrage[] = [{ id: 1577 }];
    ...
    it('Should update editForm', () => {
      ...
      optionProduitCommerces.tarifReferenceOption = tarifReferenceOption;
      const tarif: ITarif = { id: 16829 };
      optionProduitCommerces.tarif = tarif;
      const parametrage: IParametrage = { id: 4866 };
      optionProduitCommerces.parametrage = parametrage;
