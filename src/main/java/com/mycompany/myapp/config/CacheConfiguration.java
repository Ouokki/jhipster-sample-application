...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Demande.class.getName() + ".parametrages");
            createCache(cm, com.mycompany.myapp.domain.HistModifDemande.class.getName());
            createCache(cm, com.mycompany.myapp.domain.HistModifDemande.class.getName() + ".demandes");
            createCache(cm, com.mycompany.myapp.domain.CR.class.getName());
            createCache(cm, com.mycompany.myapp.domain.CR.class.getName() + ".referentielCRS");
            ...
            createCache(cm, com.mycompany.myapp.domain.TarifCommercant.class.getName() + ".parametrages");
            ...
            createCache(cm, com.mycompany.myapp.domain.OptionProduitCommerces.class.getName() + ".parametrages");
            ...
            createCache(cm, com.mycompany.myapp.domain.Conformite.class.getName() + ".parametrages");
