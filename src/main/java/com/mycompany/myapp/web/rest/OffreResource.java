...
public class OffreResource {
    ...
    public ResponseEntity<Offre> partialUpdateOffre(@PathVariable(value = "id", required = false) final Long id, @RequestBody Offre offre)
        ...
        Optional<Offre> result = offreRepository
            ...
            .map(existingOffre -> {
                if (offre.getCodeOffre() != null) {
                    existingOffre.setCodeOffre(offre.getCodeOffre());
                }
                if (offre.getLibelleOffre() != null) {
                    existingOffre.setLibelleOffre(offre.getLibelleOffre());
                }
                if (offre.getReferenceEchangeAVEM() != null) {
                    existingOffre.setReferenceEchangeAVEM(offre.getReferenceEchangeAVEM());
                }
                if (offre.getReferenceEchangeCAPS() != null) {
                    existingOffre.setReferenceEchangeCAPS(offre.getReferenceEchangeCAPS());
                }
